...
class TextAreaDemo(EasyFrame):
    """An investment calculator demonstrates the use od a multi-line text area"""
    ...
    def __init__(self):
        ...
        self.addLabel(text = "Intrest rate in %", row = 2, column = 0)
    ...
    def compute(self):
        ...
        # Obtain abd validate the inputs
        ...
        # Append the totals for the period 
            ...
            #Output the result while preserving read-only ststus 
